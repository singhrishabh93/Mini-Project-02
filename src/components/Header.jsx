        ...
        <header className="fixed z-50 w-screen  p-3 px-4 md:p-6 md:px-16">
            ...
            <div className="hidden md:flex w-full h-full items-center justify-between">
                <Link to={"/"} className="flex items-center gap-2">
                    <img src={Logo} className="w-10 object-cover" alt="logo"></img> {/*logo size w-8 */}
                    <p className="text-headingColor text-xl font-bold">Sabji Wallah</p> {/*logo text*/}
                </Link>
                ...
                alt="userprofile"
                onClick={login}/>
                {/* login button click karne ke baad ka design */}
                {
                    isMenu && (
                        <motion.div 
                    ...
                    {user && user.email === "singhrishabh1670@gmail.com" && (
                            <Link to={"/createItem"}>
            ...
            <div className="flex items-center justify-between md:hidden w-full h-full">
                ...
                {/* login button click karne ke baad ka design */}
                {
                    ...
                    <ul className="flex flex-col">
                            <li className="text-lg text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2">Home</li>
                            <li className="text-lg text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2">Menu</li>
                            <li className="text-lg text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2">About Us</li>
                            <li className="text-lg text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2">Service</li>
                    </ul>
